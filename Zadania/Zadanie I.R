...
# Uzyskaj dostęp do wyników 3 uczestnika (id: 103).
print(___)
...
# Oblicz średnią, maksimum oraz minimum oraz rozpiętość nowo utworzonej zmiennej.
srednia_dobrostan <- ___
maks_dobrostan <- ___
min_dobrostan <- ___
rozpietosc_dobrostan <- ___

# Wyświetlenie wyników obliczeń dla dobrostanu
print(___)
